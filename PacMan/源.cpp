...
namespace Pacman
{
    ...
    public:
        int height, width; // 场地的长和宽
        int generatorCount;
        int GENERATOR_INTERVAL, LARGE_FRUIT_DURATION, LARGE_FRUIT_ENHANCEMENT;

        GridStaticType fieldStatic[FIELD_MAX_HEIGHT][FIELD_MAX_WIDTH]; // 场地格子固定的内容
        GridContentType fieldContent[FIELD_MAX_HEIGHT][FIELD_MAX_WIDTH]; // 场地格子会变化的内容
